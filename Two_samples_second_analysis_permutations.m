...
%Npermutations=20;
%[net1,net2] =...
%dcor_network_single_sample_first_analysis_permutations("Inut_File1.csv","Inut_File2.csv","outputdirectory", alpha, minCI, Normalization_box, Imputationa_box,select_label,Nsubsample,Npermutations);

function Two_samples_second_analysis_permutations(Filename1,Filename2, outputdirectory, alpha, ci_min, Normalize, Imputer,select_label,NSubset,NBoot)
...
save_figure(figN, out_dir, filenamefig, net1,subnodes);
